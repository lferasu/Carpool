...
public class TripRegistrationTableServiceImpl implements TripRegistrationTableService {
    ...
    public Trip tripMapper(TripRegistrationTable tr) {
        ...
        driver.setUsername(tr.getUsername());
        driver.setEmailAddress(tr.getEmailAddress());

        /*//Driver Address
        driver.setAdrCity(tr.getAdrCity());
        driver.setAdrState(tr.getAdrState());
        driver.setAdrStreet(tr.getAdrStreet());
        driver.setAdrZip(tr.getAdrZip());*/
    ...
    public List<TripRegistrationTable> getAllRegTrips() {
      ...
      // tripRegistrationTableRepository.findAllOrderByTripStartingTimeAsc().forEach(trips::add);
