...
public class NotificationListner {
    ...
    //        @KafkaListener(topics = "${kafka.topic.newreservation:NEWRESERVATION}", groupId = "group_id")
    @KafkaListener(topics = "NEWRESERVATION", groupId = "group_id")
...
//            System.out.println("topics ===========> " + topics);
        ...
        if (notifications != null) {
            ...
            System.out.println("notifications null =========================!!!!!!!!!!!!!111 ");
    ...
    private void sendEmail(Notification notification) {
        ...
        // Send email
        System.out.println("email is sending mailMessage ================= " + mailMessage);
